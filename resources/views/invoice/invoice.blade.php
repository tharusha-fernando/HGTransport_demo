        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <img src="{{asset('/assets/img/letterhead.jpg')}}" class="img"
                    ...
                    <table border="0" width="100%">
                        <tr>
                            <td width="50%">
                                <h6 class="text-left" style="margin: 0;padding-left: 15pt"><b>INVOICE - #{{$Invoice->invoice_number}}</b></h6>
                                <h6 class="text-left" style="margin: 0;padding-left: 15pt;vertical-align: text-bottom"><b>
                                    Customer : {{$Invoice->User->name}} | {{$Invoice->section}}</b></h6>
                            </td>
                            <td width="50%">
                                <h6 class="text-right" style="margin: 0;padding-right: 20pt;vertical-align: text-top">
                                   <b> DATE-TIME : {{$Invoice->date}}</b></h6>
                                <h6 class="text-right" style="margin: 0;padding-right: 20pt;vertical-align: text-top">
                                    <b>USER : {{\Illuminate\Support\Facades\Auth::user()->name}}</b></h6>
                                ...
                                @foreach($Transports as $Transport)
                                    <tr>
                                        ...
                                        <td style="text-align: right;vertical-align: text-top;">
                                            ...
                                            Total Hours : <br> Free Hours : <br> Demurrage Hours : <br> </td> <!-- Demourage Hours :-->
                                        <td style="text-align: left;vertical-align: text-top;">
            ...
            <div class="row">
                <div class="col-md-6 pull-right" style="padding-top: 0pt">
                    ...
                    <h6 style="text-align: right;padding-right: 20pt"><b>{{$Invoice->total}} LKR</b></h6>
                    <h6 style="text-align: right;padding-right: 20pt"><b>{{$Invoice->paid}} LKR</b></h6>
                    <h6 style="text-align: right;padding-right: 20pt"><b>{{$Invoice->unpaid}} LKR</b></h6>
                ...
                <div class="col-md-6 pull-right" style="padding-top: 0pt">
                    ...
                    <h6 style="text-align: right;padding-right: 10pt"><b>Total Amount :</b></h6>
                    <h6 style="text-align: right;padding-right: 10pt"><b>Paid Amount :</b></h6>
                    <h6 style="text-align: right;padding-right: 10pt"><b>Due Amount :</b></h6>

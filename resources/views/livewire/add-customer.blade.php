                        ...
                        <form class="w-full max-w-lg mx-4" wire:submit.prevent="add_customer">
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    ...
                                    <textarea wire:model="Adress" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" placeholder="Address"></textarea>
                                </div>
                            </div>
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
